      ...
      <div className="space-y-4">
        {orgs.map((org) => (
          <div key={org._id.toString()} className="flex gap-4 items-start group bg-[#fcf9f5]/50 p-3 rounded-xl border border-transparent hover:border-[#ae8563]/20 transition-all">
            <div className="w-10 h-10 bg-white rounded-md border border-[#ae8563]/10 flex items-center justify-center text-lg font-bold text-[#ae8563] flex-shrink-0 shadow-sm mt-1">
                {org.name.charAt(0)}
            </div>
            ...
            <button className="flex-shrink-0 w-8 h-8 rounded-full bg-gray-50 hover:bg-[#ae8563]/10 text-gray-400 hover:text-[#ae8563] flex items-center justify-center transition-colors" title="View Profile">
